...
class PokemonStatPastSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PokemonStat
        #fields = ("base_stat", "effort", "stat")
        fields = ("base_stat", "generation", "stat")
...
class PokemonDetailSerializer(serializers.ModelSerializer):
    ...
    def get_past_pokemon_stats(self, obj):
        ...
        pokemon_past_stats_objects = PokemonStatPast.objects.filter(pokemon=obj)
        pokemon_past_stats = PokemonStatPastSerializer(
            pokemon_past_stats_objects, many=True, context=self.context
        ).data
